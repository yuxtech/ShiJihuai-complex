...
\begin{enuma}
  ...
  \item \makebox[0.65\textwidth][l]{$\int_0^{2\pi}\frac1{a+b\cos\theta}\textrm d\theta$  （$0<b<a$）；} $\bigg(\frac{2\pi}{\sqrt{a^2-b^2}}\bigg)$
  \item \makebox[0.65\textwidth][l]{$\int_0^{\frac\pi2}\frac1{a+\sin^2\theta}\textrm d\theta$（$a>0$）；} $\bigg(\frac\pi2\frac1{\sqrt{a(a+1)}}\bigg)$
...
\end{minipage}
  ...
  \item \makebox[0.65\textwidth][l]
  {$\int_0^{\frac\pi2}\log\sin\theta\textrm d\theta$；}
  $(-\pi\log2)$\\
  （\textbf{提示}：先求出广义积分$\int_0^{\frac\pi2}\log|\ee^{\ii\theta}-1|\textrm d\theta$.）
